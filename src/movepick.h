...
constexpr int HISTORY_DIVISOR[N_HISTORY] = { 7183, 8192, 7183, 29952 };
constexpr int HISTORY_SCALE[N_HISTORY]   = {    1,    1,    1,     1 };
constexpr int HISTORY_WEIGHT[N_HISTORY]  = {    0,    0,    0,     0 };
...
constexpr int Dmax =  HISTORY_DIVISOR[HISTORY_MAIN] * (HISTORY_SCALE[HISTORY_MAIN] + HISTORY_WEIGHT[HISTORY_MAIN]) / HISTORY_SCALE[HISTORY_MAIN]
                    ...
                    + HISTORY_DIVISOR[HISTORY_INCHECK] *  HISTORY_WEIGHT[HISTORY_INCHECK] / HISTORY_SCALE[HISTORY_INCHECK]
                    + HISTORY_DIVISOR[HISTORY_CMH0] * (HISTORY_SCALE[HISTORY_CMH0] + HISTORY_WEIGHT[HISTORY_CMH0]) / HISTORY_SCALE[HISTORY_CMH0];
constexpr int Dmin = -Dmax;
