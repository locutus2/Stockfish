...
constexpr int HISTORY_DIVISOR[N_HISTORY] = {7183, 8192, 7183, 29952, 29952, 7183, 7183};
constexpr int HISTORY_SCALE[N_HISTORY]   = {1, 1, 1, 1, 1, 1, 1};
constexpr int HISTORY_WEIGHT[N_HISTORY]  = {0, 0, 0, 0, 0, 0, 0};
