...
constexpr int KING_HISTORY_SIZE        = 64;
...
inline int king_index(const Position& pos) {
    return file_of(pos.square<KING>(BLACK)) + file_of(pos.square<KING>(WHITE)) * 8;
}
...
using KingPieceToHistory = Stats<std::int16_t, 7183, PIECE_NB, SQUARE_NB>;
