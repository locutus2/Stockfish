...
namespace {
  ...
  int W_HIDDEN[N_LAYERS-1][N_HIDDEN][N_HIDDEN+1] = {
    {
      { 673, -661, 682, -4, 214, -194, 224, -315, -223, },
      { 594, 214, 217, -265, 23, 161, -140, -48, 195, },
      { -77, -255, 261, 218, 262, 315, 230, 23, 134, },
      { -2, -91, -136, -283, 151, 63, 70, 20, 172, },
      { -369, 407, -376, -416, -248, 65, -482, -204, -154, },
      { -365, -241, -346, -216, 96, -424, -311, 526, 278, },
      { 118, 85, -152, -157, -46, 64, -103, 26, 8, },
      { 45, -79, -323, -307, 42, 271, -143, 456, 246, },
    },
  };

  int W_OUT[N_HIDDEN+1] = { -166, -25, -112, -97, -174, 2, -435, 40, -364, };
