...
moves_loop: // When in check, search starts here
    ...
    Move hopfieldMove = PvNode ? thisThread->hopfield[us].getMove(pos, {(ss-1)->currentMove, (ss-2)->currentMove}) : MOVE_NONE;
    ...
    */
    ...
    else if (bestMove)
    {
        if (PvNode && !pos.capture(bestMove))
            thisThread->hopfield[us].setMove(bestMove, {(ss-1)->currentMove, (ss-2)->currentMove});
