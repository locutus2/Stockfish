...
#ifdef N_CONDITIONS
constexpr int N_UPN_CONDITIONS = N_CONDITIONS;
#else
...
void initUPNConditions(const std::vector<Condition>& base, int keep_first_n, int use_keeped)
{
	...
	std::cerr << "Use " << base.size() << " base conditions." << std::endl;
	std::cerr << "Use " << derivedConditions.size() << " dervied conditions." << std::endl;
}
