...
Value Search::Worker::search(
  Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, const bool cutNode) {
    ...
    //const auto correctionValue2 = 1.0409172546174074588691790303573 * (1 * correctionValue + 0.55484160871571058538882135534896 * correction_value2(*this, pos, ss));
    //const auto correctionValue2 = 1.0498326662126924546164194721719 * (1 * correctionValue + 0.31593409901840994469841507759737 * correction_value2(*this, pos, ss));
    ...
    const auto correctionValue2 = 1 * (1 * correctionValue + -0.315934099 * 2 * correction_value2(*this, pos, ss));
