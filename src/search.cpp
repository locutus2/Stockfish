...
moves_loop:  // When in check, search starts here
    ...
    while ((move = mp.next_move()) != Move::none())
    {
        ...
        if (depth >= 2 && moveCount > 1)
        {
             ...
             * CC = true
             * F = 0
             * Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             * Hit #10: Total 47916596 Hits 0 Hit Rate (%) 0
             * Sum #0: 1.99753e+07
             * Sum #1: 2.79413e+07
             * Sum #10: 4.07708e+07
             * Sum #11: 7.14582e+06
             ...
             * Sum #90: 4.21853e+07
             * Sum #91: 5.73132e+06
             * Sum #100: 5.73132e+06 => BEST !ss->incheck => alpha = 0.99806297421816483242034177358189
             * Sum #101: 4.21853e+07
             * Sum #110: 3.30349e+07
             * Sum #111: 1.48817e+07
             * Sum #120: 1.48817e+07
            ...
            /*
             * CC = true
             double F = 0.99806297421816483242034177358189 * (2*!ss->inCheck-1);
             * Hit #0: Total 47916596 Hits 45004542 Hit Rate (%) 93.9227
             * Hit #1: Total 45004542 Hits 41978781 Hit Rate (%) 93.2768
             * Sum #0: 1.1704e+07
             * Sum #1: 1.93943e+07
             * Sum #10: 2.16057e+07
             * Sum #11: 9.49269e+06
             ...
             * Sum #70: 2.25434e+07
             * Sum #71: 8.55502e+06
             * Sum #80: 8.55502e+06 => BEST !givesCheck => alpha = 0.48446204751314156757993323416039
             * Sum #81: 2.25434e+07
             * Sum #90: 1.55492e+07
             * Sum #91: 1.55492e+07
             * Sum #100: 1.55492e+07
             ...
             * CC = true
             double F =  0.99806297421816483242034177358189 * (2*!ss->inCheck-1)
                       + 0.48446204751314156757993323416039 * (2*!givesCheck-1);
             * Hit #0: Total 47916596 Hits 45004542 Hit Rate (%) 93.9227
             * Hit #1: Total 45004542 Hits 41978781 Hit Rate (%) 93.2768
             * Sum #0: 9.81345e+06
             * Sum #1: 1.79613e+07
             ...
             * Sum #30: 1.86237e+07
             * Sum #31: 9.15108e+06
             * Sum #40: 9.15108e+06 => BEST !imprving => alpha = 0.35528152903143576932716045164976
             * Sum #41: 1.86237e+07
             * Sum #50: 1.51203e+07
             * Sum #51: 1.26544e+07
             * Sum #60: 1.26544e+07
             ...
             * CC = true
             double F =  0.99806297421816483242034177358189 * (2*!ss->inCheck-1)
                       + 0.48446204751314156757993323416039 * (2*!givesCheck-1)
                       + 0.35528152903143576932716045164976 * (2*!improving-1);
             * Hit #0: Total 47916596 Hits 45004542 Hit Rate (%) 93.9227
             * Hit #1: Total 45004542 Hits 41978781 Hit Rate (%) 93.2768
             * Sum #0: 1.00618e+07
             * Sum #1: 1.60477e+07
             ...
             * */
             ...
             Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             Hit #10: Total 47916596 Hits 0 Hit Rate (%) 0
             Sum #0: 2.17173e+06 => BEST  allNode => alpha = 0.28714649817862405893562794994767
             Sum #1: 3.85672e+06
             Sum #10: 2.95527e+06
             Sum #11: 3.07318e+06
             Sum #20: 3.91568e+06
            ...
            /*
             * CC = true
             double F = 0.28714649817862405893562794994767 * (2 * allNode - 1);
             * Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             * Hit #10: Total 47916596 Hits 26614730 Hit Rate (%) 55.5439
             * Hit #11: Total 26614730 Hits 25661905 Hit Rate (%) 96.4199
             * Sum #0: 2.89409e+06
             * Sum #1: 2.89409e+06
             * Sum #10: 2.80172e+06
             * Sum #11: 2.98646e+06
             ...
             * Sum #120: 3.1534e+06
             * Sum #121: 2.63478e+06
             * Sum #130: 2.48985e+06 => BEST ss->ttPv => alpha = 0.14059539011718396439779333372621
             * Sum #131: 3.29832e+06
             * Sum #140: 3.29832e+06
             * Sum #141: 2.48985e+06
             * */
             ...
             * CC = true
             double F = 0.28714649817862405893562794994767 * (2 * allNode - 1)
                      + 0.14059539011718396439779333372621 * (2 * ss->ttPv - 1);
             * Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             * Hit #10: Total 47916596 Hits 26614730 Hit Rate (%) 55.5439
             * Hit #11: Total 26614730 Hits 25661905 Hit Rate (%) 96.4199
             * Sum #0: 2.84847e+06
             ...
             * */
              ...
              * Sum #80: 2.79551e+06
              * Sum #81: 436747
              * Sum #90: 206495 => BEST ss->inCheck => alpha = 1.3423206897730385506410344155897
              * Sum #91: 3.02576e+06
              * Sum #100: 3.02576e+06
              * Sum #101: 206495
              * Sum #110: 411074
            ...
            /*
             * CC = true
             double F = 1.3423206897730385506410344155897 * (2 * ss->inCheck - 1);
             * Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             * Hit #10: Total 47916596 Hits 2912054 Hit Rate (%) 6.07734
             * Hit #11: Total 2912054 Hits 2705559 Hit Rate (%) 92.909
             * Sum #0: 531963
             * Sum #1: 1.04893e+06
             * Sum #10: 109498 => BEST PvNode => alpha = 1.2990282634885149863170378819238
             * Sum #11: 1.47139e+06
             * Sum #20: 939430
             * Sum #21: 641461
             * Sum #30: 503656
             ...
             * CC = true
             double F = 1.3423206897730385506410344155897 * (2 * ss->inCheck - 1)
                      + 1.2990282634885149863170378819238 * (2 * PvNode - 1);
             * Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             * Hit #10: Total 47916596 Hits 2912054 Hit Rate (%) 6.07734
             * Hit #11: Total 2912054 Hits 2705559 Hit Rate (%) 92.909
             * Sum #0: 145118 => BEST allNode => alpha = 0.75557499954764750593398079906006
             * Sum #1: 657666
             * Sum #10: 401392
             * Sum #11: 401391
             * Sum #20: 256274
             ...
             * CC = true
             double F = 1.3423206897730385506410344155897 * (2 * ss->inCheck - 1)
                      + 1.2990282634885149863170378819238 * (2 * PvNode - 1)
                      + 0.75557499954764750593398079906006 + (2 * allNode - 1);
             Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             Hit #10: Total 47916596 Hits 1943445 Hit Rate (%) 4.05589
             Hit #11: Total 1943445 Hits 1850745 Hit Rate (%) 95.2301
             Hit #12: Total 3232256 Hits 3139556 Hit Rate (%) 97.132
             Sum #0: 308932
             Sum #1: 308932
             Sum #10: 188550
             Sum #11: 429314
             ...
             Sum #60: 573032
             Sum #61: 44831.8
             Sum #70: 39512.3 => BEST givesCheck => alpha = 1.3417853320047217005936158460747
             Sum #71: 578352
             Sum #80: 578352
             Sum #81: 39512.3
             Sum #90: 320172
             ...
             * CC = true
             double F = 1.3423206897730385506410344155897 * (2 * ss->inCheck - 1)
                      + 1.2990282634885149863170378819238 * (2 * PvNode - 1)
                      + 0.75557499954764750593398079906006 * (2 * allNode - 1)
                      + 1.3417853320047217005936158460747 * (2 * givesCheck - 1);
             * Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             * Hit #10: Total 47916596 Hits 418533 Hit Rate (%) 0.873461
             * Hit #11: Total 418533 Hits 386603 Hit Rate (%) 92.371
             * Hit #12: Total 3232256 Hits 3200326 Hit Rate (%) 99.0121
             * Sum #0: 157912
             * Sum #1: 144426
             * Sum #10: 77891.4
             * Sum #11: 224446
             ...
             * Sum #40: 187038
             * Sum #41: 115300
             * Sum #50: 22351.1 => BEST capture => alpha = 1.2639338183346417466202750921783
             * Sum #51: 279987
             * Sum #60: 279987
             * Sum #61: 22351.1
             * Sum #70: 151169
             ...
             * CC = true
             double F = 1.3423206897730385506410344155897 * (2 * ss->inCheck - 1)
                      ...
                      + 0.75557499954764750593398079906006 * (2 * allNode - 1)
                      + 1.3417853320047217005936158460747 * (2 * givesCheck - 1)
                      + 1.2639338183346417466202750921783 * (2 * capture - 1);
             * Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             * Hit #10: Total 47916596 Hits 500515 Hit Rate (%) 1.04455
             * Hit #11: Total 500515 Hits 483653 Hit Rate (%) 96.6311
             * Hit #12: Total 3232256 Hits 3215394 Hit Rate (%) 99.4783
             * Sum #0: 84252.9
             * Sum #1: 73962.4
             * Sum #10: 38618.6
             * Sum #11: 119597
             * Sum #20: 35343.8 => BEST cutNode => alpha = 0.6230060182684260241042876584943
             * Sum #21: 122871
             * Sum #30: 55143.1
             * Sum #31: 103072
             * Sum #40: 103072
             ...
             * CC = true
             double F = 1.3423206897730385506410344155897 * (2 * ss->inCheck - 1)
                      ...
                      + 1.3417853320047217005936158460747 * (2 * givesCheck - 1)
                      + 1.2639338183346417466202750921783 * (2 * capture - 1)
                      + 0.6230060182684260241042876584943 * (2 * cutNode - 1);
             * Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             * Hit #10: Total 47916596 Hits 500515 Hit Rate (%) 1.04455
             * Hit #11: Total 500515 Hits 483653 Hit Rate (%) 96.6311
             * Hit #12: Total 3232256 Hits 3215394 Hit Rate (%) 99.4783
             * Sum #0: 45187.3
             * Sum #1: 86611.7
             * Sum #10: 20712.3 => BEST PvNode => alpha = 0.83979297569838861399726675424082
             * Sum #11: 111087
             * Sum #20: 65899.4
             * Sum #21: 65899.6
             * Sum #30: 50300.3
             ...
             * CC = true
             double F = 1.3423206897730385506410344155897 * (2 * ss->inCheck - 1)
                      ...
                      + 1.2639338183346417466202750921783 * (2 * capture - 1)
                      + 0.6230060182684260241042876584943 * (2 * cutNode - 1)
                      + 0.83979297569838861399726675424082 * (2 * PvNode - 1);
             * Hit #0: Total 47916596 Hits 44684340 Hit Rate (%) 93.2544
             * Hit #10: Total 47916596 Hits 53901 Hit Rate (%) 0.112489
             * Hit #11: Total 53901 Hits 51785 Hit Rate (%) 96.0743
             * Hit #12: Total 3232256 Hits 3230140 Hit Rate (%) 99.9345
             * Sum #0: 19511.9
             * Sum #1: 76422.7
             * Sum #10: 47967.3
             * Sum #11: 47967.3
