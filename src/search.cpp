    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
              ...
              || (cutNode && (ss-1)->moveCount > 1)))
      {
          ...
          if (   PvNode
              ...
              && thisThread->rootMoves[thisThread->pvIdx + 1].previousScore != VALUE_INFINITE
              && thisThread->rootMoves[thisThread->pvIdx].previousScore > 200 + thisThread->rootMoves[thisThread->pvIdx + 1].previousScore)
              r++;
