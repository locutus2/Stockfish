...
Value Search::Worker::search(
  Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, const bool cutNode) {
    ...
    if (((allNode && correctionValue > 24486584) || cutNode || (false&&allNode /*&& correctionValue > 8*1024*1024*//*-0*33554432*/)) && ss->staticEval >= beta - 13 * depth - 47 * improving + 365 && !excludedMove
