...
namespace {
  ...
  constexpr double W_IN[N_HIDDEN][N_IN+1] = {
    { -0.120112, 0.0213965, 0.183301, 0.0285742, },
    { -0.265044, -0.325933, -0.189844, -0.130469, },
    { -0.229077, -0.15979, -0.294683, -0.159253, },
    { -0.237793, 0.0148779, 0.10606, -0.323818, },
    { -0.188623, -0.239512, 0.214937, 0.286704, },
    { 0.147417, 0.0328369, -0.0311865, -0.0671729, },
    { -0.0199268, -0.300981, 0.271177, 0.094375, },
    { 0.141304, 0.252495, 0.267227, 0.263726, },
  };

  constexpr double W_HIDDEN[N_LAYERS-1][N_HIDDEN][N_HIDDEN+1] = {
    {
      { 0.270283, -0.353398, 0.466118, 0.287085, 0.114805, 0.0341699, 0.13562, -0.166289, -0.170967, },
      { 0.412983, 0.0982959, 0.0893115, -0.227363, -0.0134229, 0.133437, -0.123433, 0.0888525, 0.105576, },
      { -0.461265, -0.072085, 0.385513, 0.117681, -0.00673828, 0.0701514, 0.189868, -0.131499, -0.125645, },
      { 0.0680371, -0.0243311, -0.0627881, -0.181143, 0.0682471, -0.0463281, 0.150049, -0.0651611, 0.0586523, },
      { -0.135474, 0.107017, -0.246704, -0.252876, -0.00592773, -0.0784668, -0.17958, -0.221187, 0.0671631, },
      { 0.0139355, -0.517925, -0.21479, 0.0142188, -0.135664, -0.0342578, -0.395049, 0.346367, 0.124683, },
      { 0.284639, -0.284653, -0.225283, -0.0436914, -0.117773, -0.121489, 0.22793, -0.159941, -0.121211, },
      { -0.0376025, -0.0479932, -0.335923, -0.111606, 0.0102588, 0.332529, -0.151025, 0.0615967, -0.0149805, },
    },
  };

  constexpr double W_OUT[N_HIDDEN+1] = { -0.0681494, -0.0499512, -0.225981, -0.103535, 0.0961914, 0.121421, -0.2721, 0.0965137, -0.167813, };
         ...
         && !(Limits.depth && mainThread && rootDepth > Limits.depth))
  {
          ...
          && !mainThread->stopOnPonderhit)
      {
          ...
          double totalTime =  Time.optimum() * fallingEval * reduction * bestMoveInstability
                            * calculateTimeCorrection(fallingEval, reduction, bestMoveInstability);
