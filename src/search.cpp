    ...
    while ((move = mp.next_move()) != Move::none())
    {
        ...
        if(CC)
		{
             ...
             */
             ...
             for(int i = -S; i <= S; i++)
             {
                 std::vector<double> f = basefactor;
                 f[histIndex] += i/double(S);
                 factor0.push_back(f);
             }
             ...
             /*
                 ...
                 */
                 ...
                 //{ 2.+2,2.+1,1.+1./2,1.-1./2,1.,1.-1./2,1.},
                 //{ 2.+2,2.+1,1.+1./2,1.-1./2,1.,1.-1./2,1.-1},
             for(int i = 0; i < int(factor0.size()); i++)
             {
                 h.push_back((factor0[i][0] * x[0]
                                 + factor0[i][1] * x[1]
                                 + factor0[i][2] * x[2]
                                 + factor0[i][3] * x[3]
                                 + factor0[i][4] * x[4]
