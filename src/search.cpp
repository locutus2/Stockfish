...
namespace {
  ...
  void update_all_stats(const Position& pos, Stack* ss, Move bestMove, Value bestValue, Value beta, Square prevSq, Move ttMove,
...
moves_loop: // When in check, search starts here
    ...
    */
    ...
    // If there is a move that produces search value greater than alpha we update the stats of searched moves
        ...
        update_all_stats(pos, ss, bestMove, bestValue, beta, prevSq, ttMove,
  ...
  void update_all_stats(const Position& pos, Stack* ss, Move bestMove, Value bestValue, Value beta, Square prevSq, Move ttMove,
    ...
    if (!pos.capture_stage(bestMove))
    {
        ...
        update_quiet_stats(pos, ss, bestMove, bestMoveBonus * (2 + (ttMove && bestMove != ttMove)) / 2);
