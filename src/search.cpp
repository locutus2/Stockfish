...
static constexpr int R_log[CALLER_NB] = { S(2834,2883), S(2834,3018), S(2834,2775), S(2834,2693), S(2834,2617), S(2834,3076), S(2834,2895), S(2834,2874), S(2834,2804) };
static constexpr int R_delta[CALLER_NB] = { S(617,643), S(617,610), S(617,603), S(617,597), S(617,597), S(617,661), S(617,671), S(617,601), S(617,610) };
static constexpr int R_imp[CALLER_NB] = { S(194,187), S(194,200), S(194,204), S(194,206), S(194,195), S(194,194), S(194,195), S(194,184), S(194,194) };
static constexpr int R_offset[CALLER_NB] = { S(1027,985), S(1027,988), S(1027,1027), S(1027,1088), S(1027,937), S(1027,1050), S(1027,974), S(1027,1018), S(1027,1100) };
