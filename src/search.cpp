...
TUNE(SetRange(-100,100), IMP, NOTIMP);

#define RED(n) (1024 * (\
                           ( \
                              improving * (IMP[(n)][1] > 0) + !improving * (NOTIMP[(n)][1] > 0) \
                           ) \
                           - \
                           ( \
                              improving * (IMP[(n)][0] > 0) + !improving * (NOTIMP[(n)][0] > 0) \
                           ) \
                ))
