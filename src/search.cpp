...
namespace {
  ...
  int W_HIDDEN[N_LAYERS-1][N_HIDDEN][N_HIDDEN+1] = {
    {
      { 70, -84, 261, 182, 222, -232, 20, -80, 142, },
      { 291, 165, 395, 85, -9, 59, 82, 37, 203, },
      { -60, -313, 202, 168, 47, 153, 38, -10, -70, },
      { -121, -142, 46, -213, 181, 166, 68, 5, 2, },
      { -169, 142, -311, -385, 352, -57, -320, -264, 195, },
      { -299, -169, -244, -18, 48, -118, -29, 392, 163, },
      { 36, 384, -46, 157, 75, 123, -127, -158, 102, },
      { 153, -160, -119, -14, 233, 187, -186, 24, -19, },
    },
  };

  int W_OUT[N_HIDDEN+1] = { 194, 248, -157, 46, 143, -11, -34, 31, -97, };
