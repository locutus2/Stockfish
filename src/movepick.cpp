...
TUNE(SetRange(-7183, 7183), T[0][0], T[1][0]);
TUNE(SetRange(-8192, 8192), T[0][1], T[1][1]);
TUNE(SetRange(-29952, 29952),
     T[0][2],
     T[0][3],
     T[0][4],
     T[0][5],
...
inline int TRANS(int i, int h) { return T[1][i] + (h - T[0][i]) * (S + A[h > T[0][i]][i]) / S; }
