        ...
        else if constexpr (Type == QUIETS)
        {
            ...
            m.values = {
              ...
              int((ply < LOW_PLY_HISTORY_SIZE
                     ...
                     : 0)),
              int(2 * (*badMainHistory[0])[us][m.raw()]),
              int(2 * (*badMainHistory[1])[us][m.raw()]),
              int(2 * (*badMainHistory[2])[us][m.raw()]),
              int(2 * (*badMainHistory[3])[us][m.raw()]),
            };
        }
