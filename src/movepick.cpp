      ...
      if constexpr (Type == CAPTURES)
          ...
          m.value =  2 * (*mainHistory)[pos.side_to_move()][from_to(m)]
                   ...
                   +     (threatenedPieces & from_sq(m) ?
                          ...
                          :                                                                           0)
                          :                                                                           0)
                   +     (  type_of(pos.moved_piece(m)) == ROOK   && (safeRookAttacksOnQueen   & to_sq(m)) ? 5000
                          : type_of(pos.moved_piece(m)) == BISHOP && (safeBishopAttacksOnQueen & to_sq(m)) ? 5000
                          : type_of(pos.moved_piece(m)) == KNIGHT && (safeKnightAttacksOnQueen & to_sq(m)) ? 5000
                          :                                                                                  0)
